...
with DAG("my_dag", start_date=datetime(2022,5,4),schedule_interval="@daily",catchup=False) as dag:
    ...
    choose_best_model = PythonOperator(task_id ="choose_best_model", python_callable=_choose_best_model)
